# Generated by Powerlevel10k configuration wizard on 2020-09-12 at 23:36 KST.
...
# no frame, sparse, fluent, instant_prompt=quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,REMOTE,SUDO}_{CONTENT,VISUAL_IDENTIFIER}_EXPANSION=
